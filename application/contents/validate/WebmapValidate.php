 ...
 */
use think\Validate;
class WebmapValidate extends Validate{
    ...
    protected $message  =   [ 
        ...
        'flag.require'          => '请输入标识符',
        'flag.chsDash'          => '标识符只能是字母/数字/下划线/扩折号',
        'flag.length'           => '标识符长度在2-20个字符',
        'icon.length'           => '图标地址长度1-256',
        'indexno.number'        => '序号只能为数字',
        'indexno.between'       => '序号范围1-65535',
        'url.length'            => 'url长度1-256',
    ];
